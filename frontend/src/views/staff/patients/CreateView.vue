        ...
        <v-card>
          ...
          <v-card-text>
            <v-form ref="form" v-model="valid">
              ...
              <v-checkbox
                v-model="patient.create_portal_account"
                label="Create patient portal account"
                color="primary"
              ></v-checkbox>
              
              <v-row v-if="patient.create_portal_account">
                <v-col cols="12" md="6">
                  <v-text-field
  ...
  setup() {
    ...
    const submit = async () => {
      ...
      try {
        ...
        delete data.create_portal_account
        ...
        showSnackbar('Failed to create patient: ' + error.message, 'error')
      } finally {
