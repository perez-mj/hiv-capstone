// backend/migrations/20260101000001-create-core-tables.js
'use strict';
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable('patients', {
      ...
      suffix: { type: S.TEXT, allowNull: true },
      suffix_hash: { type: S.STRING(64), allowNull: true },
      ...
      email_hash: { type: S.STRING(64), allowNull: true },

      facebook_messenger: { type: S.TEXT, allowNull: true },
      facebook_messenger_hash: { type: S.STRING(64), allowNull: true },

      // ---------- STRUCTURED ADDRESS ----------
      // House # / street / purok / sitio — the free-text part below barangay.
      // Encrypted like the rest of PII.
      sitio_street: { type: S.TEXT, allowNull: true },

      // PSGC FKs. No region_id and no postal_code by design:
      //  - region is derivable via cities_municipalities.region_id
      //  - postal codes are not maintained in the PSGC dataset
      barangay_id: {
      ...
      purpose_hash: { type: S.STRING(64), allowNull: true },
    ...
    await queryInterface.addIndex('patients', ['suffix_hash']);
    ...
    await queryInterface.addIndex('patients', ['email_hash']);
    await queryInterface.addIndex('patients', ['facebook_messenger_hash']);
    await queryInterface.addIndex('patients', ['purpose_hash']);
    ...
    // Structured address indexes
    await queryInterface.addIndex('patients', ['province_id']);
    await queryInterface.addIndex('patients', ['city_municipality_id']);
    await queryInterface.addIndex('patients', ['barangay_id']);
